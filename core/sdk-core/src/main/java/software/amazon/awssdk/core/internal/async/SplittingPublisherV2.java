...
public class SplittingPublisherV2 implements SdkPublisher<AsyncRequestBodyWrapper> {
    ...
    private class SplittingSubscriber implements Subscriber<ByteBuffer> {
         ...
         * unless the data has been delivered
         */
        private final class DownstreamBody implements ClosableAsyncRequestBody {
            ...
            private final BufferingAsyncRequestBody delegate;
            ...
            private DownstreamBody(boolean contentLengthKnown, long maxLength, int chunkNumber) {
                ...
                this.delegate = new BufferingAsyncRequestBody(totalLength);
            }
            ...
            public void complete() {
                ...
                if (totalLength != null && bufferedLength != totalLength) {
                    // TODO add validation
                }
                delegate.complete();
            }

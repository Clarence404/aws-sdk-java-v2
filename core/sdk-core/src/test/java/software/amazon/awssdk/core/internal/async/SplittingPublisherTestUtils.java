...
//
//     public static void verifyIndividualAsyncRequestBody(SdkPublisher<AsyncRequestBodyWrapper> publisher,
//                                                         Path file,
...
//             requestBody.requestBody().subscribe(subscriber);
//             futures.add(baosFuture);
//             baosFuture.whenComplete((response, throwable) -> {
//                 System.out.println("baos future completed");});
